...
```bash
repo init -u https://github.com/CannedOS/manifest.git -b 11

```
You can alternatively use this command to save some space and time :

```bash
repo init --depth=1 -u https://github.com/CannedOS/manifest.git -b 11
 ...
 * [**TitaniumOS**](https://github.com/TitaniumOS)
